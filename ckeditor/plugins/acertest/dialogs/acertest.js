...
CKEDITOR.dialog.add( 'acertest', function( editor ) {
	// Define some shorthands.
	var $el = CKEDITOR.dom.element,
		$doc = CKEDITOR.document,
		lang = editor.lang.acertest,
		colorCellCls = 'cke_acertest_colorcell',
		focusedColorLightCls = 'cke_acertest_focused_light',
		focusedColorDarkCls = 'cke_acertest_focused_dark',
		selectedColorCls = 'cke_acertest_selected';
	...
	function createColorTable() {
		table = CKEDITOR.dom.element.createFromHtml( '<table tabIndex="-1" class="cke_acertest_table"' +
	...
	// Load CSS.
	CKEDITOR.document.appendStyleSheet( CKEDITOR.getUrl( CKEDITOR.plugins.get( 'acertest' ).path + 'dialogs/acertest.css' ) );
