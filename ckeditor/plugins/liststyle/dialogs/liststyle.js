				...
				contents: [ {
					...
					elements: [ {
						...
						},
						{
							...
							setup: function( element ) {
								// var value = element.getStyle( 'list-style-type' ) || mapListStyle[ element.getAttribute( 'type' ) ] || element.getAttribute( 'type' ) || '';
								//element.setAttribute('class', 'chinese1');
								// element.setAttribute('class', 'chinese1');
							},
							commit: function( element ) {
								debugger;
								...
								var value = this.getValue();
								if (value && !isNaN(start) && start >= 0){
									element.setAttribute('class', value);
									element.setStyle('list-style','none');
									element.setStyle('counter-reset', this.getValue()+' ' +start);
								}else{
									element.removeAttribute('class');
									element.removeStyle('list-style');
									element.removeStyle('counter-reset');
								}
							}
						} ]
					} ]
