...
(function() {
		...
		return {
			...
			on: function(b, d, g, k, h) {
				...
				if (0 > e.getListenerIndex(d)) {
					...
					p.fn = d;
					p.priority = h;
					for (var v = e.length - 1; 0 <= v; v--)
						if (e[v].priority <= h) return e.splice(v + 1, 0, p), {
							removeListener: q
						};
					e.unshift(p)
				}
			...
			fire: function() {
				...
				return function(h, p, q) {
					...
					if (e) {
						var v = e.listeners;
						if (v.length)
							for (var v = v.slice(0), x, F = 0; F < v.length; F++) {
								if (e.errorProof) try {
									x = v[F].call(this, q, p, b, k)
								} catch (u) {} else x = v[F].call(this, q, p, b, k);
								!1 === x ? g = 1 : "undefined" != typeof x && (p = x);
								if (a || g) break
							}
					}
	...
	(function() {
		...
		CKEDITOR.tools = {
			...
			parseCssText: function(a, b, e) {
				...
				if (!a || ";" == a) return c;
				a.replace(/&quot;/g, '"').replace(/\s*([^:;\s]+)\s*:\s*([^;]+)\s*(?=;|$)/g, function(a, e, y) {
					b && (e = e.toLowerCase(), "font-family" == e && (y = y.replace(/\s*,\s*/g, ",")), y = CKEDITOR.tools.trim(y));
					c[e] = y
				});
				return c
			},
		...
		CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
			...
			removeStyle: function(a) {
				...
				if (b.removeProperty || "border" != a && "margin" != a && "padding" != a) b.removeProperty ? b.removeProperty(a) : b.removeAttribute(CKEDITOR.tools.cssStyleToDomStyle(a)), this.$.style.cssText || this.removeAttribute("style");
					...
					for (var b = [], d = 0; d < c.length; d++)
						if (e)
							for (var v = 0; v < e.length; v++) b.push([a, c[d], e[v]].join("-"));
			...
			getDocumentPosition: function(a) {
				var b = 0,
					...
					e = this.getDocument(),
					d = e.getBody(),
					v = "BackCompat" == e.$.compatMode;
				if (document.documentElement.getBoundingClientRect && (CKEDITOR.env.ie ? 8 !== CKEDITOR.env.version : 1)) {
					var f = this.$.getBoundingClientRect(),
						g = e.$.documentElement,
						u = g.clientTop || d.$.clientTop || 0,
						m = g.clientLeft || d.$.clientLeft || 0,
						k = !0;
					CKEDITOR.env.ie && (k = e.getDocumentElement().contains(this), e = e.getBody().contains(this), k = v && e || !v && k);
					k && (CKEDITOR.env.webkit || CKEDITOR.env.ie && 12 <= CKEDITOR.env.version ? (b = d.$.scrollLeft || g.scrollLeft, c = d.$.scrollTop || g.scrollTop) : (c = v ? d.$ : g, b = c.scrollLeft, c = c.scrollTop), b = f.left + b - m, c = f.top + c - u)
				} else
					for (u = this, m = null; u && "body" != u.getName() && "html" != u.getName();) {
						b += u.$.offsetLeft - u.$.scrollLeft;
						c += u.$.offsetTop - u.$.scrollTop;
						u.equals(this) || (b += u.$.clientLeft || 0, c += u.$.clientTop || 0);
						for (; m && !m.equals(u);) b -= m.$.scrollLeft, c -= m.$.scrollTop, m = m.getParent();
						m = u;
				...
				document.documentElement.getBoundingClientRect || !CKEDITOR.env.gecko || v || (b += this.$.clientLeft ? 1 : 0, c += this.$.clientTop ? 1 : 0);
				return {
					x: b,
					y: c
				}
			...
			scrollIntoParent: function(a, b, c) {
				...
				var n = a.$.clientHeight,
					r = a.$.clientWidth;
				v = d.x - m(this, "left") - w.x || 0;
				f = d.y - m(this, "top") - w.y || 0;
				e = d.x + e + m(this, "right") - (w.x + r) || 0;
				d = d.y + H + m(this, "bottom") - (w.y + n) || 0;
				(0 > f || 0 < d) && g(0, !0 === b ? f : !1 === b ? d : 0 > f ? f : d);
				c && (0 > v || 0 < e) && g(0 > v ? v : e, 0)
			},
			...
			copyAttributes: function(a, b) {
				...
				for (var e = 0; e < c.length; e++) {
					var d = c[e],
						...
						f;
					if (!(v in b))
						if ("checked" == v && (f = this.getAttribute(v))) a.setAttribute(v, f);
						else if (!CKEDITOR.env.ie || this.hasAttribute(v)) f = this.getAttribute(v), null === f && (f = d.nodeValue), a.setAttribute(v, f)
				}
	...
	(function() {
		function a(a, b) {
			...
			if (!a && !this._.guardLTR) {
				var L = e.type == CKEDITOR.NODE_ELEMENT ? e : e.getParent(),
					h = e.type == CKEDITOR.NODE_ELEMENT ? e.getChild(y) : e.getNext();
				this._.guardLTR = function(a, b) {
					return (!b || !L.equals(a)) && (!h || !a.equals(h)) && (a.type != CKEDITOR.NODE_ELEMENT || !b || !a.equals(c.root))
				}
			}
			if (a && !this._.guardRTL) {
				...
				this._.guardRTL = function(a, b) {
					return (!b || !k.equals(a)) && (!t || !a.equals(t)) && (a.type != CKEDITOR.NODE_ELEMENT || !b || !a.equals(c.root))
				}
			}
			var D = a ? this._.guardRTL : this._.guardLTR;
			g = n ? function(a, b) {
				return !1 === D(a, b) ? !1 : n(a, b)
			} : D;
			this.current ? e = this.current[C](!1, r, g) : (a ? e.type == CKEDITOR.NODE_ELEMENT && (e = 0 < y ? e.getChild(y - 1) : !1 === g(e, !0) ? null : e.getPreviousSourceNode(!0, r, g)) : (e = d, e.type == CKEDITOR.NODE_ELEMENT && ((e = e.getChild(f)) || (e = !1 === g(d, !0) ? null : d.getNextSourceNode(!0, r, g)))), e && !1 === g(e) && (e = null));
			for (; e && !this._.end;) {
				this.current = e;
		...
		CKEDITOR.dom.walker.editable = function(a) {
			return function(b) {
				b = q(b) ? !1 : b.type == CKEDITOR.NODE_TEXT || b.type == CKEDITOR.NODE_ELEMENT && (b.is(CKEDITOR.dtd.$inline) || b.is("hr") || "false" == b.getAttribute("contenteditable") || !CKEDITOR.env.needsBrFiller && b.is(y) && e(b)) ? !0 : !1;
				return !!(a ^ b)
			}
		};
	...
	(function() {
		...
		function d(a, b, c, d, f) {
			...
			var r = a.startContainer,
				...
				E = a.endOffset,
				N, t, D, z, I, P;
			if (n && C.type == CKEDITOR.NODE_TEXT && (r.equals(C) || r.type === CKEDITOR.NODE_ELEMENT && r.getFirst().equals(C))) c.append(a.document.createText(C.substring(L, E)));
			else {
				C.type == CKEDITOR.NODE_TEXT ? n ? P = !0 : C = C.split(E) : 0 < C.getChildCount() ? E >= C.getChildCount() ? (C = C.getChild(E - 1), t = !0) : C = C.getChild(E) : z = t = !0;
				r.type == CKEDITOR.NODE_TEXT ? n ? I = !0 : r.split(L) : 0 < r.getChildCount() ? 0 === L ? (r = r.getChild(L), N = !0) : r = r.getChild(L - 1) : D = N = !0;
				for (var O = r.getParents(), l = C.getParents(), K = m(),
						B = O.length - 1, A = l.length - 1, J = c, G, X, V, da = -1, Q = K; Q <= B; Q++) {
					X = O[Q];
					V = X.getNext();
					for (Q != B || X.equals(l[Q]) && B < A ? b && (G = J.append(X.clone(0, f))) : N ? g(X, J, !1, D) : I && J.append(a.document.createText(X.substring(L))); V;) {
						if (V.equals(l[Q])) {
							da = Q;
							break
						}
				...
				for (Q = K; Q <= A; Q++)
					if (c = l[Q], V = c.getPrevious(), c.equals(O[Q])) b && (J = J.getChild(0));
						...
						Q != A || c.equals(O[Q]) && A < B ? b && (G = J.append(c.clone(0, f))) : t ? g(c, J, !1, z) : P && J.append(a.document.createText(c.substring(0, E)));
						if (Q > da)
							for (; V;) V = g(V, J, !0);
						J = G
					}
		...
		CKEDITOR.dom.range.prototype = {
			...
			enlarge: function(a, b) {
				...
				switch (a) {
					...
					case CKEDITOR.ENLARGE_ELEMENT:
						...
						E.type == CKEDITOR.NODE_TEXT ? (t && (E = !CKEDITOR.tools.trim(E.substring(0, t)).length && E, L = !!E), E && ((r = E.getPrevious()) || (n = E.getParent()))) : (t && (r = E.getChild(t - 1) || E.getLast()), r || (n = E));
						for (n = c(n); n || r;) {
							if (n && !r) {
								!C && n.equals(m) && (C = !0);
							...
							for (; r;)
								if (E = !1, r.type == CKEDITOR.NODE_COMMENT) r = r.getPrevious();
								else {
									if (r.type == CKEDITOR.NODE_TEXT) N = r.getText(), d.test(N) && (r = null), E = /[\s\ufeff]$/.test(N);
									else if ((r.$.offsetWidth > (CKEDITOR.env.webkit ? 1 : 0) || b && r.is("br")) && !r.data("cke-bookmark"))
										if (L && CKEDITOR.dtd.$removeEmpty[r.getName()]) {
											N = r.getText();
											if (d.test(N)) r = null;
											else
												for (var t = r.$.getElementsByTagName("*"), D = 0, z; z = t[D++];)
									...
									E && (L ? C ? k = n : n && this.setStartBefore(n) : L = !0);
									if (r) {
										E = r.getPrevious();
										if (!n && !E) {
											n = r;
						...
						n = r = null;
						C = L = !1;
						E.type == CKEDITOR.NODE_TEXT ? CKEDITOR.tools.trim(E.substring(t)).length ? L = !0 : (L = !E.getLength(), t == E.getLength() ? (r = E.getNext()) || (n = E.getParent()) : g(E, t) && (n = E.getParent())) : (r = E.getChild(t)) || (n = E);
						for (; n || r;) {
							if (n && !r) {
								!C && n.equals(m) && (C = !0);
								if (f ? n.isBlockBoundary() : !h.contains(n)) break;
							...
							for (; r;) {
								E = !1;
								if (r.type == CKEDITOR.NODE_TEXT) N = r.getText(), g(r, 0) || (r = null), E = /^[\s\ufeff]/.test(N);
									...
									if ((0 < r.$.offsetWidth || b && r.is("br")) && !r.data("cke-bookmark"))
										if (L && CKEDITOR.dtd.$removeEmpty[r.getName()]) {
											...
											if (d.test(N)) r = null;
												...
												for (t = r.$.getElementsByTagName("*"), D = 0; z = t[D++];)
													if (!CKEDITOR.dtd.$removeEmpty[z.nodeName.toLowerCase()]) {
														r = null;
														break
													}
			...
			_getTableElement: function(a) {
				...
				return d && !this.root.contains(d) ? null : CKEDITOR.env.safari && d && c.equals(this.root) ? b.getAscendant(a, !0) : this.getEnclosedNode() ? this.getEnclosedNode().getAscendant(a, !0) : d && f && (d.equals(f) || d.contains(f) || f.contains(d)) ? b.getAscendant(a, !0) : null
			},
		...
		a.prototype = {
			getNextParagraph: function(a) {
				...
				if (!this._.started) {
					...
					k = u.startPath();
					var m = u.endPath(),
						M = !u.collapsed && c(u, k.block),
						w = !u.collapsed && c(u, m.block, 1);
					u.shrink(CKEDITOR.SHRINK_ELEMENT, !0);
					M && u.setStartAt(k.block, CKEDITOR.POSITION_BEFORE_END);
					w && u.setEndAt(m.block, CKEDITOR.POSITION_AFTER_START);
				...
				for (this._.nextNode = null; m;) {
					...
					if (k && !M)
						for (; !m.getNext(h) && !v;) {
							r = m.getParent();
							if (r.isBlockBoundary(this.forceBrBreak && !w && {
									br: 1
								})) {
								M = 1;
								H = 0;
					...
					m = this._getNextSourceNode(m, n, u);
					if ((v = !m) || M && k) break
				}
				if (!d) {
				...
				F && (x = d.getLast()) && x.type == CKEDITOR.NODE_ELEMENT && "br" == x.getName() && (!CKEDITOR.env.needsBrFiller || x.getPrevious(g) || x.getNext(g)) && x.remove();
				this._.nextNode || (this._.nextNode = v || d.equals(u) || !u ? null : this._getNextSourceNode(d, 1, u));
				return d
			},
	...
	(function() {
		function a(a, b, c, d, e) {
			...
			for (f in b) {
				...
				for (g in P) {
					...
					var r = l,
						...
						C = void 0;
					z ? A = !1 : z = {};
					for (C in B) "!" == C.charAt(0) && (C = C.slice(1), h.push(C), z[C] = !0, A = !1);
			...
			for (d = a.length; c < d; ++c) {
				...
				for (g in O) {
					...
					z = [];
					B = void 0;
					for (B in t) - 1 < B.indexOf("*") ? z.push(new RegExp("^" + B.replace(/\*/g, ".*") + "$")) : z.push(B);
					t = z;
					t.length && (l[m] = t, r = !1)
				}
				l.nothingRequired = r;
		...
		function e(a) {
			var b, c, d, e, f = {},
				n = 1;
			for (a = z(a); b = a.match(l);)(c = b[2]) ? (d = y(c, "styles"), e = y(c, "attrs"), c = y(c, "classes")) : d = e = c = null, f["$" + n++] = {
				elements: b[1],
				classes: c,
				styles: d,
				attributes: e
		...
		function x(a, b, e, f) {
			...
			if (f.doCallbacks && a.elementCallbacks) {
				a: {
					...
					for (var g = 0, t = n.length, D; g < t; ++g)
						if (D = n[g](b)) {
							n = D;
							break a
						}
			...
			if (f.doFilter) {
				a: {
					...
					if (a || n) {
						...
						if (t)
							for (k = 0, C = t.length; k < C; ++k) c(t[k], b, z);
						if (a)
							for (k = 0, C = a.length; k < C; ++k) d(a[k], b, z, D);
						if (n)
							for (k = 0, C = n.length; k < C; ++k) d(n[k], b, z, D);
						a = z
					} else a = null
				}
				...
				var g = b.attributes,
					I = b.styles,
					t = b.classes;D = b.classBackup;
				var L = b.styleBackup,
					K, E, O = [],
					z = [],
					J = /^data-cke-/;k = !1;delete g.style;delete g["class"];delete b.classBackup;delete b.styleBackup;
				if (!a.allAttributes)
					for (K in g) C[K] || (J.test(K) ? K == (E = K.replace(/^data-cke-saved-/, "")) || C[E] || (delete g[K], k = !0) : (delete g[K], k = !0));
				...
				if (!a.allClasses || a.hadInvalidClass) {
					for (K = 0; K < t.length; ++K)(a.allClasses || n[t[K]]) && z.push(t[K]);
					z.length && (g["class"] = z.sort().join(" "));
					D && z.length < D.split(/\s+/).length && (k = !0)
				} else D && (g["class"] = D);k && (l = 1);
		...
		function n(a, b, c) {
			var d = a.name;
			if (t.$empty[d] || !a.children.length) "hr" == d && "br" == b ? a.replaceWith(w()) : (a.parent && c.push({
				check: "it",
				el: a.parent
			}), a.remove());
			else if (t.$block[d] || "tr" == d)
				if ("br" == b) a.previous && !H(a.previous) && (b = w(), b.insertBefore(a)), a.next && !H(a.next) && (b = w(), b.insertAfter(a)), a.replaceWithChildren();
				else {
					var d = a.children,
						e;
					b: {
		...
		CKEDITOR.filter.prototype = {
			...
			applyTo: function(a, b, c, d) {
				...
				for (; z = a.pop();)
					if (c = z.el, c.parent) switch (k = t[c.parent.name] || t.span, z.check) {
						case "it":
				...
				if (!this.disabled && a) {
					...
					for (e = 0; e < a.length; ++e) {
						...
						var f = void 0,
							...
							t = void 0;
						c = [];
						for (n = 0; n < b.length; ++n) l = b[n], "string" == typeof l ? (l = l.split(/\s*:\s*/), g = l[0], m = null, t = l[1]) : (g = l.check, m = l.left, t = l.right), f || (f = l, f = f.element ? f.element : g ? g.match(/^([a-z0-9]+)/i)[0] : f.left.getDefinition().element), m instanceof CKEDITOR.style && (m = E(m)), c.push({
							check: g == f ? null : g,
							left: m,
			...
			check: function(a, b, c) {
				...
				} else f = a.getDefinition(), l = f.styles, d = f.attributes || {}, l && !CKEDITOR.tools.isEmpty(l) ? (l = D(l), d.style = CKEDITOR.tools.writeCssText(l, !0)) : l = {}, f = {
					name: f.element,
					attributes: d,
				...
				k = function(b) {
					a.call(this, b, function(a) {
						...
						for (e in a) {
							...
							if (!d[e]) {
								if (h.icons)
									for (var x = h.icons.split(","), F = x.length; F--;) CKEDITOR.skin.addIcon(x[F], h.path + "icons/" + (CKEDITOR.env.hidpi && h.hidpi ? "hidpi/" : "") + x[F] + ".png");
								d[e] = 1
							}
							if (v)
								for (v.split && (v = v.split(",")), h = 0; h < v.length; h++) g[v[h]] || b.push(v[h])
						}
	...
	(function() {
		...
		CKEDITOR.htmlParser.fragment.fromHtml = function(g, k, h) {
				...
				if (0 < m.length)
					for (var c = 0; c < m.length; c++) {
						var d = m[c],
							e = d.name,
							f = CKEDITOR.dtd[e],
							n = w.name && CKEDITOR.dtd[w.name];
						n && !n[e] || a && f && !f[a] && CKEDITOR.dtd[a] ? e == w.name && (y(w, w.parent, 1), c--) : (b || (q(), b = 1), d = d.clone(), d.parent = w, w = d, m.splice(c, 1), c--)
					}
			}

			function q() {
				for (; M.length;) y(M.shift(), w)
			}
			...
			function y(b, c, d) {
				c = c || w || u;
				var f = w;
				void 0 === b.previous && (v(c, b) && (w = c, F.onTagOpen(h, {}), b.returnPoint = c = w), e(b), a(b) && !b.children.length || c.add(b), "pre" == b.name && (n = !1), "textarea" == b.name && (H = !1));
			...
			F.onTagOpen = function(e, f, g, k) {
				...
				if (a(f)) m.push(f);
					...
					if ("br" == e) M.push(f);
						...
						for (; !(k = (g = w.name) ? CKEDITOR.dtd[g] || (w._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c, f.isUnknown || w.isUnknown || k[e]);)
							if (w.isOptionalClose) F.onTagClose(g);
							else if (e in b && g in b) g = w.children, (g = g[g.length - 1]) && "li" == g.name || y(g = new CKEDITOR.htmlParser.element("li"), w), !f.returnPoint && (f.returnPoint = w), w = g;
						else if (e in CKEDITOR.dtd.$listItem && !x(e, g)) F.onTagOpen("li" == e ? "ul" : "dl", {}, 0, 1);
						else if (g in d && !x(e, g)) !f.returnPoint && (f.returnPoint = w), w = w.parent;
						else if (g in CKEDITOR.dtd.$inline && m.unshift(w), w.parent) y(w, w.parent, 1);
						else {
							f.isOrphan = 1;
							break
						}
			...
			F.onTagClose = function(a) {
				...
				for (var c = [], d = [], e = w; e != u && e.name != a;) e._.isBlockLike || d.unshift(e), c.push(e), e = e.returnPoint || e.parent;
				if (e != u) {
			...
			F.onText = function(a) {
				if (!(w._.hasInlineStarted && !M.length || n || H) && (a = CKEDITOR.tools.ltrim(a), 0 === a.length)) return;
				var b = w.name,
		...
		a.prototype = {
			...
			exec: function(a, c) {
				var d = c instanceof CKEDITOR.htmlParser.node || c instanceof CKEDITOR.htmlParser.fragment,
					...
					p, q, e, y;
				for (y = 0; y < h; y++)
					if (d && (p = c.type, q = c.name), e = k[y], !(a.nonEditable && !e.options.applyToAll || a.nestedEditable && e.options.excludeNestedEditable)) {
	...
	(function() {
		function a(a, d) {
				...
				return function(f) {
					if (f.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
						var l = [],
							...
							D, G;
						if (n)
							for (t(n, 1) && l.push(n); n;) g(n) && (D = c(n)) && t(D) && ((G = c(D)) && !g(G) ? l.push(D) : (e(z).insertAfter(D), D.remove())), n = n.previous;
						for (n = 0; n < l.length; n++) l[n].remove();
						if (l = !a || !1 !== ("function" == typeof d ? d(f) : d)) z || CKEDITOR.env.needsBrFiller || f.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT ? z || CKEDITOR.env.needsBrFiller || !(7 < document.documentMode || f.name in CKEDITOR.dtd.tr || f.name in CKEDITOR.dtd.$listItem) ? (l = b(f), l = !l || "form" == f.name && "input" == l.name) : l = !1 : l = !1;
						l && f.add(e(a))
					}
				}
			}
			...
			function t(a, b) {
				...
				var c;
				return a.type == CKEDITOR.NODE_TEXT && (c = a.value.match(w)) && (c.index && ((new CKEDITOR.htmlParser.text(a.value.substring(0, c.index))).insertBefore(a), a.value = c[0]), !CKEDITOR.env.needsBrFiller && z && (!b || a.parent.name in B) || !z && ((c = a.previous) && "br" == c.name || !c || g(c))) ? !0 : !1
			}
			var D = {
					elements: {}
				},
			...
			for (h in B) D.elements[h] = l(z, a.config.fillEmptyBlocks);
			D.root = l(z, !1);
		...
		function q(a) {
			return a.replace(D, function(a, b, c) {
				return "\x3c" + b + c.replace(z, function(a, b) {
		...
		function M(a, b) {
			...
			return a = a.replace(/<(title|iframe|textarea)([^>]*)>([\s\S]*?)<\/\1>/g, function(a, c, d, e) {
				return "\x3c" + c + d + "\x3e" + m(u(e), b) + "\x3c/" + c + "\x3e"
			})
		}
		...
		CKEDITOR.htmlDataProcessor.prototype = {
			toHtml: function(a, b, c, d) {
				var e = this.editor,
					f, l, n, g;
				b && "object" == typeof b ? (f = b.context, c = b.fixForBody, d = b.dontFilter, l = b.filter, n = b.enterMode, g = b.protectedWhitespaces) : f = b;
		...
		var D = /<(a|area|img|input|source)\b([^>]*)>/gi,
			...
			K = new RegExp("(" + x("\x3ccke:encoded\x3e") + "(.*?)" + x("\x3c/cke:encoded\x3e") + ")|(" + x("\x3c") + x("/") + "?" + x("cke:encoded\x3e") + ")", "gi"),
		...
		function b(a) {
			var b = a.name,
				...
				b = CKEDITOR.dom.element.createFromHtml(q.output({
					...
					bottomHtml: p ? '\x3cspan id\x3d"' + a.ui.spaceId("bottom") + '" class\x3d"cke_bottom cke_reset_all" style\x3d"display:none;" role\x3d"presentation"\x3e' + p + "\x3c/span\x3e" : "",
	...
	(function() {
		...
		u = function() {
			...
			function b(c, d) {
				...
				e = d.range.startPath();
				for (var z = D[z.getName()], h = 0, I = c.getChildren(), m = I.count(), q = -1, p = -1, P = 0, E = e.contains(D.$list); h < m; ++h) e = I.getItem(h), a(e) ? (g = e.getName(), E && g in CKEDITOR.dtd.$list ? k = k.concat(b(e, d)) : (t = !!z[g], "br" != g || !e.data("cke-eol") || h && h != m - 1 || (P = (f = h ? k[h - 1].node : I.getItem(h + 1)) && (!a(f) || !f.is("br")), f = f && a(f) && D.$block[f.getName()]), -1 != q || t || (q = h), t || (p = h), k.push({
					isElement: 1,
					isLineBreak: P,
			...
			function d(b, c) {
				var e = [],
					...
					t, k = 0,
					h = D[c],
					z = !b.is(D.$inline) || b.is("br");
				for (z && e.push(" "); k < g; k++) t = f.getItem(k), a(t) && !t.is(h) ? e = e.concat(d(t, c)) : e.push(t);
				z && e.push(" ");
				return e
			}
			...
			function g(b, c, d, e) {
				...
				(t = (new CKEDITOR.dom.walker(f)).next()) && a(t) && z[t.getName()] && (k = t.getPrevious()) && a(k) && !k.getParent().equals(b.startContainer) && d.contains(k) && e.contains(t) && t.isIdentical(k) && (t.moveChildren(k), t.remove(), g(b, c, d, e))
			}
			...
			var D = CKEDITOR.dtd,
				...
				m = CKEDITOR.tools.extend({}, D.$inline);
			delete m.br;
			return function(z, l, K, B) {
				var A = z.editor,
					J = !1;
				...
				if (!B.checkReadOnly()) {
					...
					B = z.mergeCandidates;
					var q, p;
					"text" == z.type && l.shrink(CKEDITOR.SHRINK_ELEMENT, !0, !1) && (q = CKEDITOR.dom.element.createFromHtml("\x3cspan\x3e\x26nbsp;\x3c/span\x3e", l.document), l.insertNode(q), l.setStartAfter(q));
					J = new CKEDITOR.dom.elementPath(l.startContainer);
					z.endPath = G = new CKEDITOR.dom.elementPath(l.endContainer);
					if (!l.collapsed) {
						var A = G.block || G.blockLimit,
							v = l.getCommonAncestor();
						A && !A.equals(v) && !A.contains(v) && l.checkEndOfBlock() && z.zombies.push(A);
						l.deleteContents()
					}
					for (;
						(p = e(l)) && a(p) && p.isBlockBoundary() && J.contains(p);) l.moveToPosition(p, CKEDITOR.POSITION_BEFORE_END);
					g(l, z.blockLimit, J, G);
					...
					if (q = K) {
						...
						p.setHtml(K);
						u && (p.getFirst().remove(), p.getLast().remove());
						if ((u = q.startPath().block) && (1 != u.getChildCount() || !u.getBogus())) a: {
							var y;
							if (1 == p.getChildCount() && a(y = p.getFirst()) && y.is(I) && !y.hasAttribute("contenteditable")) {
								u = y.getElementsByTag("*");
								q = 0;
								for (B = u.count(); q < B; q++)
									if (l = u.getItem(q), !l.is(m)) break a;
					...
					if (q) {
						...
						var H, M;
						l = y.startContainer;
						var J = z.endPath.elements[0],
							W, G = J.getPosition(l),
							v = !!J.getCommonAncestor(l) && G != CKEDITOR.POSITION_IDENTICAL && !(G & CKEDITOR.POSITION_CONTAINS + CKEDITOR.POSITION_IS_CONTAINED);
						l = b(z.dataWrapper, z);
						for (t(l, y); B < l.length; B++) {
							G = l[B];
							if (x = G.isLineBreak) {
								x = y;
								H = p;
								var S = void 0,
									Y = void 0;
								G.hasBlockSibling ? x = 1 : (S = x.startContainer.getAscendant(D.$block, 1)) && S.is({
									div: 1,
									p: 1
								}) ? (Y = S.getPosition(H), Y == CKEDITOR.POSITION_IDENTICAL || Y == CKEDITOR.POSITION_CONTAINS ? x = 0 : (H = x.splitElement(S), x.moveToPosition(H, CKEDITOR.POSITION_AFTER_START), x = 1)) : x = 0
							}
							if (x) K = 0 < B;
							else {
								x = y.startPath();
								!G.isBlock && k(z.editor, x.block, x.blockLimit) && (T = h(z.editor)) && (T = q.createElement(T), T.appendBogus(), y.insertNode(T), CKEDITOR.env.needsBrFiller && (w = T.getBogus()) && w.remove(), y.moveToPosition(T, CKEDITOR.POSITION_BEFORE_END));
								if ((x = y.startPath().block) && !x.equals(F)) {
									if (w = x.getBogus()) w.remove(), u.push(x);
									F = x
								}
								G.firstNotAllowed && (A = 1);
								if (A && G.isElement) {
									x = y.startContainer;
									for (H = null; x && !D[x.getName()][G.name];) {
										if (x.equals(p)) {
											x = null;
											break
										}
									...
									if (x) H && (M = y.splitElement(H), z.zombies.push(M), z.zombies.push(H));
									else {
										H = p.getName();
										W = !B;
										x = B == l.length - 1;
								...
								if (W) {
									for (; x = W.pop();) y.insertNode(x);
									W = 0
								} else y.insertNode(G.node);
								G.lastNotAllowed && B < l.length - 1 && ((M = v ? J : M) && y.setEndAt(M, CKEDITOR.POSITION_AFTER_START), A = 0);
								y.collapse()
							}
						}
						1 != l.length ? w = !1 : (w = l[0], w = w.isElement && "false" == w.node.getAttribute("contenteditable"));
						w && (K = !0, x = l[0].node, y.setStartAt(x, CKEDITOR.POSITION_BEFORE_START), y.setEndAt(x, CKEDITOR.POSITION_AFTER_END));
						z.dontMoveCaret = K;
						z.bogusNeededBlocks = u
					}
					w = z.range;
					var R;
					M = z.bogusNeededBlocks;
					for (W = w.createBookmark(); F = z.zombies.pop();) F.getParent() && (T = w.clone(), T.moveToElementEditStart(F), T.removeEmptyBlocksAtEnd());
					if (M)
						for (; F = M.pop();) CKEDITOR.env.needsBrFiller ? F.appendBogus() : F.append(w.document.createText(" "));
					for (; F = z.mergeCandidates.pop();) F.mergeSiblings();
					w.moveToBookmark(W);
					if (!z.dontMoveCaret) {
						for (F = e(w); F && a(F) && !F.is(D.$empty);) {
							if (F.isBlockBoundary()) w.moveToPosition(F, CKEDITOR.POSITION_BEFORE_END);
							else {
	...
	(function() {
		...
		CKEDITOR.on("instanceCreated", function(a) {
			...
			c.on("contentDom", function() {
				...
				if (CKEDITOR.env.ie || D) m ? h.attachListener(h, "beforedeactivate", a, null, null, -1) : h.attachListener(c, "selectionCheck", a, null, null, -1), h.attachListener(h, CKEDITOR.env.webkit || CKEDITOR.env.gecko ? "focusout" : "blur", function() {
					c.lockSelection(p);
					q = 1
				}, null, null, -1), h.attachListener(h, "mousedown", function() {
					q = 0
				});
				if (CKEDITOR.env.ie && !D) {
					var v;
							...
							n.on("mousedown", function(a) {
								function b(a) {
									...
									if (r) {
										...
										r.setEndPoint(0 > x.compareEndPoints("StartToStart", c) ? "EndToEnd" : "StartToStart", c);
										r.select()
									}
								}
						...
						if (l) this.fake(l);
							...
							if (m) {
								...
								for (G = 0; G < a.length; G++) {
									...
									b.collapsed && CKEDITOR.env.webkit && q(b) && (l = e(this.root), b.insertNode(l), (A = l.getNext()) && !l.getPrevious() && A.type == CKEDITOR.NODE_ELEMENT && "br" == A.getName() ? (y(this.root), b.moveToPosition(A, CKEDITOR.POSITION_BEFORE_START)) : b.moveToPosition(l, CKEDITOR.POSITION_AFTER_END));
	...
	(function() {
		...
		function b(c) {
			...
			if (c.collapsed) e = M(this, e), c.insertNode(e), c.moveToPosition(e, CKEDITOR.POSITION_BEFORE_END);
				...
				for (r.getPosition(v) == CKEDITOR.POSITION_FOLLOWING && (r = 0); r;) {
					m = !1;
					if (r.equals(v)) r = null, m = !0;
					else {
						var u = r.type == CKEDITOR.NODE_ELEMENT ? r.getName() : null,
							x = u && "false" == r.getAttribute("contentEditable"),
							w = u && r.getAttribute("data-nostyle");
						if (u && r.data("cke-bookmark") || r.type === CKEDITOR.NODE_COMMENT) {
							r = r.getNextSourceNode(!0);
							continue
						}
						if (x && n && CKEDITOR.dtd.$block[u])
						...
						D = u ? !q[u] || w ? 0 : x && !n ? 0 : d(r, v, h, P) : 1;
						if (D)
							if (E = r.getParent(), D = h, H = g, I = k, !E || !(E.getDtd() || CKEDITOR.dtd.span)[H] && !I || D.parentRule && !D.parentRule(E)) m = !0;
							else {
								if (y || u && CKEDITOR.dtd.$removeEmpty[u] && (r.getPosition(v) | P) != P || (y = c.clone(), y.setStartBefore(r)), u = r.type, u == CKEDITOR.NODE_TEXT || x || u == CKEDITOR.NODE_ELEMENT && !r.getChildCount()) {
									for (var u = r, N;
										(m = !u.getNext(z)) && (N = u.getParent(), q[N.getName()]) && d(N, t, h, O);) u = N;
									y.setEndAfter(u)
								}
							}
						else m = !0;
						r = r.getNextSourceNode(w || x)
					}
					if (m && y && !y.collapsed) {
						for (var m = M(this, e), x = m.hasAttributes(), w = y.getCommonAncestor(), u = {}, D = {}, E = {}, H = {}, U, R, aa; m && w;) {
							if (w.getName() == g) {
								for (U in h.attributes) !H[U] && (aa = w.getAttribute(R)) && (m.getAttribute(U) == aa ? D[U] = 1 : H[U] = 1);
								for (R in h.styles) !E[R] && (aa = w.getStyle(R)) && (m.getStyle(R) == aa ? u[R] = 1 : E[R] = 1)
							}
							w = w.getParent()
						}
						for (U in D) m.removeAttribute(U);
						for (R in u) m.removeStyle(R);
						x && !m.hasAttributes() && (m = null);
						m ? (y.extractContents().appendTo(m), y.insertNode(m), F.call(this, m), m.mergeSiblings(), CKEDITOR.env.ie || m.$.normalize()) : (m = new CKEDITOR.dom.element("span"), y.extractContents().appendTo(m), y.insertNode(m), F.call(this, m), m.remove(!0));
						y = null
					}
				}
				c.moveToBookmark(p);
			...
			if (a.collapsed) {
				for (var f = new CKEDITOR.dom.elementPath(d.getParent(), a.root), g, h = 0, k; h < f.elements.length && (k = f.elements[h]) && k != f.block && k != f.blockLimit; h++)
					if (this.checkElementRemovable(k)) {
						var m;
						!e && a.collapsed && (a.checkBoundaryOfElement(k, CKEDITOR.END) || (m = a.checkBoundaryOfElement(k, CKEDITOR.START))) ? (g = k, g.match = m ? "start" : "end") : (k.mergeSiblings(), k.is(this.element) ? x.call(this, k) : u(k, n(this)[k.getName()]))
					}
				if (g) {
					e = d;
					for (h = 0;; h++) {
				...
				var q = c.endNode,
					p = this;
				b();
				for (f = d; !f.equals(q);) g = f.getNextSourceNode(), f.type == CKEDITOR.NODE_ELEMENT && this.checkElementRemovable(f) && (f.getName() == this.element ? x.call(this, f) : u(f, n(this)[f.getName()]), g.type == CKEDITOR.NODE_ELEMENT && g.contains(d) && (b(), g = d.getNext())), f = g
			}
			a.moveToBookmark(c);
		...
		function p(a) {
			...
			for (var d, e; d = c.getNextParagraph();) this.checkElementRemovable(d) && (d.is("pre") ? ((e = this._.enterMode == CKEDITOR.ENTER_BR ? null : a.document.createElement(this._.enterMode == CKEDITOR.ENTER_P ? "p" : "div")) && d.copyAttributes(e), q(d, e)) : x.call(this, d));
			a.moveToBookmark(b)
		}
		...
		function F(a) {
			for (var b = n(this), c = a.getElementsByTag(this.element), d, e = c.count(); 0 <= --e;) d = c.getItem(e), d.isReadOnly() || x.call(this, d, !0);
			for (var f in b)
				if (f != this.element)
		...
		CKEDITOR.style = function(a, b) {
			...
			this.type = a.type || (E[c] ? CKEDITOR.STYLE_BLOCK : N[c] ? CKEDITOR.STYLE_OBJECT : CKEDITOR.STYLE_INLINE);
	...
	*/
	...
	(function() {
		...
		function Y(a) {
			function b(b) {
				...
				if (d == CKEDITOR.DIALOG_RESIZE_WIDTH || d == CKEDITOR.DIALOG_RESIZE_BOTH) n = Math.max(e.minWidth || 0, F - g);
		...
		function M(a) {
			var b = CKEDITOR.document.getWindow(),
				...
				g = y[c];
			g ? g.show() : (f = ['\x3cdiv tabIndex\x3d"-1" style\x3d"position: ', CKEDITOR.env.ie6Compat ? "absolute" : "fixed", "; z-index: ", f, "; top: 0px; left: 0px; ", CKEDITOR.env.ie6Compat ? "" : "background-color: " + d, '" class\x3d"cke_dialog_background_cover"\x3e'], CKEDITOR.env.ie6Compat && (d = "\x3chtml\x3e\x3cbody style\x3d\\'background-color:" + d + ";\\'\x3e\x3c/body\x3e\x3c/html\x3e", f.push('\x3ciframe hidefocus\x3d"true" frameborder\x3d"0" id\x3d"cke_dialog_background_iframe" src\x3d"javascript:'), f.push("void((function(){" + encodeURIComponent("document.open();(" + CKEDITOR.tools.fixDomain + ")();document.write( '" + d + "' );document.close();") + "})())"), f.push('" style\x3d"position:absolute;left:0;top:0;width:100%;height: 100%;filter: progid:DXImageTransform.Microsoft.Alpha(opacity\x3d0)"\x3e\x3c/iframe\x3e')), f.push("\x3c/div\x3e"), g = CKEDITOR.dom.element.createFromHtml(f.join("")), g.setOpacity(void 0 !== e ? e : .5), g.on("keydown", H), g.on("keypress", H), g.on("keyup", H), g.appendTo(CKEDITOR.document.getBody()), y[c] = g);
		...
		CKEDITOR.dialog = function(a, b) {
			...
			function d(b) {
				if (l == CKEDITOR.dialog._.currentTop) {
					...
					else if (-1 != CKEDITOR.tools.indexOf(g, c) && l._.tabBarMode) c = -1 != CKEDITOR.tools.indexOf([d ? 39 : 37, 38], c) ? w.call(l) : z.call(l), l.selectPage(c), l._.tabs[c][0].focus(), q = 1;
			...
			this.on("ok", function(a) {
				t(function(b) {
					if (b.validate) {
						...
						S.call(b, !d, "string" == typeof c ? c : void 0);
						return d
					}
				})
			}, this, null, 0);
		...
		CKEDITOR.dialog.prototype = {
			...
			show: function() {
				...
				null === CKEDITOR.dialog._.currentTop ? (CKEDITOR.dialog._.currentTop = this, this._.parentDialog = null, M(this._.editor)) : (this._.parentDialog = CKEDITOR.dialog._.currentTop, this._.parentDialog.getElement().getFirst().$.style.zIndex -= Math.floor(this._.editor.config.baseFloatZIndex / 2), CKEDITOR.dialog._.currentTop = this);
				a.on("keydown", P);
				a.on("keyup", Q);
				this._.hasFocus = !1;
			...
			addPage: function(a) {
				if (!a.requiredContent || this._.editor.filter.check(a.requiredContent)) {
					...
					a.accessKey && (R(this, this, "CTRL+" + a.accessKey, ba, ca), this._.accessKeyMap["CTRL+" + a.accessKey] = a.id)
				}
			},
			selectPage: function(a) {
				if (this._.currentTabId != a && !this._.tabs[a][0].hasClass("cke_dialog_tab_disabled") && !1 !== this.fire("selectPage", {
					...
					CKEDITOR.env.ie6Compat || CKEDITOR.env.ie7Compat ? (J(d[1]), d[1].show(), setTimeout(function() {
						J(d[1], 1)
					}, 0)) : d[1].show();
		...
		L.prototype = {
			get: function(a) {
				return C(this.elements, a, "children")
			},
			add: function(a, b) {
	...
	(function() {
		...
		function w(a) {
			...
			a.getClipboardData = function(b, c) {
				...
				!1 === x() && (a.removeListener("paste", d), a._.forcePasteDialog && h && a.fire("pasteDialog") ? (a.on("pasteDialogCommit", e), a.on("dialogHide", function(a) {
					a.removeListener();
		...
		CKEDITOR.plugins.add("clipboard", {
			...
			init: function(a) {
				...
				a.on("paste", function(b) {
					...
					if ("text" == d && "html" == g) f = v(a, f, c.get("plain-text"));
				...
				for (var g, b = a[d].parent.getDocument(), h = new CKEDITOR.dom.documentFragment(b), k = null, c = d, p = Math.max(a[d].indent, 0), m = null, n, r, y = f == CKEDITOR.ENTER_P ? "p" : "div";;) {
					...
					if (q.indent == p) {
						...
						var k = g.getDirection(1) != n,
							...
							x;
						for (g = 0; g < z; g++)
							if (v = q.contents[g], I(v) && 1 < z) J ? x = v.clone(1, 1) : m.append(v.clone(1, 1));
		...
		C.prototype = {
			exec: function(a) {
				...
				for (var e = g.createBookmarks(!0), h = [], c = {}, b = b.createIterator(), p = 0;
					...
					k = k.createIterator();
					for (k.forceBrBreak = this.state == CKEDITOR.TRISTATE_OFF; m = k.getNextParagraph();)
	...
	CKEDITOR.plugins.add("scayt", {
		...
		onLoad: function(a) {
			...
			CKEDITOR.document.appendStyleSheet(CKEDITOR.getUrl(this.path + "dialogs/liststyle.css"))
		},
		init: function(a) {
			var c = this,
	...
	(function() {
		function q(d, f) {
			...
			function c(a) {
				0 < e.length || a.type != CKEDITOR.NODE_ELEMENT || !F.test(a.getName()) || a.getCustomData("selected_cell") || (CKEDITOR.dom.element.setMarker(g, a, "selected_cell", !0), e.push(a))
			}
			var e = [],
				g = {};
			if (!d) return e;
			for (var a = d.getRanges(), k = 0; k < a.length; k++) {
				...
				if (h.collapsed)(h = h.getCommonAncestor().getAscendant({
					...
					for (h.guard = c; l = h.next();) l.type == CKEDITOR.NODE_ELEMENT && l.is(CKEDITOR.dtd.table) || (l = l.getAscendant({
						td: 1,
						th: 1
					}, !0)) && !l.getCustomData("selected_cell") && b(l) && (CKEDITOR.dom.element.setMarker(g, l, "selected_cell", !0), e.push(l))
				}
			}
		...
		function r(d, f) {
			for (var b = D(d) ? d : q(d), c = b[0], e = c.getAscendant("table"), c = c.getDocument(), g = b[0].getParent(), a = g.$.rowIndex, b = b[b.length - 1], k = b.getParent().$.rowIndex + b.$.rowSpan - 1, b = new CKEDITOR.dom.element(e.$.rows[k]), a = f ? a : k, g = f ? g : b,
					b = CKEDITOR.tools.buildTableMap(e), e = b[a], a = f ? b[a - 1] : b[a + 1], b = b[0].length, c = c.createElement("tr"), k = 0; e[k] && k < b; k++) {
				var h;
				1 < e[k].rowSpan && a && e[k] == a[k] ? (h = e[k], h.rowSpan += 1) : (h = (new CKEDITOR.dom.element(e[k])).clone(), h.removeAttribute("rowSpan"), h.appendBogus(), c.append(h), h = h.$);
				k += h.colSpan - 1
			}
			f ? c.insertBefore(g) : c.insertAfter(g);
			return c
		}
		...
		function B(d) {
			if (d instanceof CKEDITOR.dom.selection) {
				...
				g = new CKEDITOR.dom.element(e[a + 1] || (0 < g ? e[g - 1] : null) || c.$.parentNode);
				for (d = b.length; 0 <= d; d--) B(b[d]);
				return c.$.parentNode ? g : (f[0].select(), null)
			}
		...
		function u(d, f) {
			for (var b = D(d) ? d : q(d), c = b[0].getAscendant("table"),
					e = w(b, 1), b = w(b), g = f ? e : b, a = CKEDITOR.tools.buildTableMap(c), c = [], e = [], b = [], k = a.length, h = 0; h < k; h++) c.push(a[h][g]), e.push(f ? a[h][g - 1] : a[h][g + 1]);
			for (h = 0; h < k; h++) c[h] && (1 < c[h].colSpan && e[h] == c[h] ? (a = c[h], a.colSpan += 1) : (g = new CKEDITOR.dom.element(c[h]), a = g.clone(), a.removeAttribute("colSpan"), a.appendBogus(), a[f ? "insertBefore" : "insertAfter"].call(a, g), b.push(a), a = a.$), h += a.rowSpan - 1);
			return b
		}
		...
		function y(d) {
			...
			for (d = a.length; m < d; m++)
				for (var n = 0, p = a[m].length; n < p; n++) void 0 === k && a[m][n] == e.$ && (k = n), a[m][n] == g.$ && (h = n);
			for (m = k; m <= h; m++)
				for (n = 0; n < a.length; n++) g = a[n], e = new CKEDITOR.dom.element(c.$.rows[n]), g = new CKEDITOR.dom.element(g[m]), g.$ && (1 == g.$.colSpan ? g.remove() : --g.$.colSpan, n += g.$.rowSpan - 1, e.$.cells.length || l.push(e));
			k = a[0].length - 1 > h ? new CKEDITOR.dom.element(a[0][h + 1]) : k && -1 !== a[0][k - 1].cellIndex ? new CKEDITOR.dom.element(a[0][k - 1]) : new CKEDITOR.dom.element(c.$.parentNode);
		...
		function z(d) {
			if (d instanceof CKEDITOR.dom.selection) {
				var f = d.getRanges(),
					...
					e;
				a: {
					var g = 0;e = b.length - 1;
					for (var a = {}, k, h; k = b[g++];) CKEDITOR.dom.element.setMarker(a, k, "delete_cell", !0);
					for (g = 0; k = b[g++];)
					...
					CKEDITOR.dom.element.clearAllMarkers(a);g = b[0].getParent();
					(g = g.getPrevious()) ? e = g.getLast() : (g = b[e].getParent(), e = (g = g.getNext()) ? g.getChild(0) : null)
				}
				d.reset();
		...
		function x(d, f, b) {
			...
			var a = CKEDITOR.tools.buildTableMap(e),
				k = a.length,
				h = a[0].length,
			...
			if (f) {
				...
				try {
					...
					g = parseInt(d.getAttribute("colspan"), 10) || 1;
					n = a["up" == f ? l - p : "down" == f ? l + p : l]["left" == f ? m - g : "right" == f ? m + g : m]
				} catch (x) {
					return !1
				}
				if (!n || d.$ == n) return !1;
			...
			for (f = 0; f < c.length; f++) {
				...
				var t = g.getParent(),
					...
					p = Math.max(p, B - m + v);
				n = Math.max(n, t - l + z);
				b || (v = g, (z = v.getBogus()) && z.remove(), v.trim(), g.getChildren().count() && (t == r || !y || y.isBlockBoundary && y.isBlockBoundary({
					br: 1
				}) || (r = u.getLast(CKEDITOR.dom.walker.whitespaces(!0)), !r || r.is && r.is("br") || u.append("br")), g.moveChildren(u)), f ? g.remove() : g.setHtml(""));
				r = t
			}
			if (b) return n * p == w;
			u.moveChildren(d);
		...
		function C(d, f) {
			...
			if (1 < h) {
				l = Math.ceil(h / 2);
				for (var h = Math.floor(h / 2), c = a + l, e = new CKEDITOR.dom.element(e.$.rows[c]), g = A(g, c), m, c = b.clone(), a = 0; a < g.length; a++)
					if (m = g[a], m.parentNode == e.$ && a > k) {
						c.insertBefore(new CKEDITOR.dom.element(m));
						break
					} else m = null;
				m || e.append(c)
			} else
				for (h = l = 1, e = c.clone(), e.insertAfter(c), e.append(c = b.clone()), m = A(g, a), k = 0; k < m.length; k++) m[k].rowSpan++;
			c.appendBogus();
			b.$.rowSpan = l;
			c.$.rowSpan = h;
		...
		function E(d, f) {
			...
			if (1 < a) c = Math.ceil(a / 2), a = Math.floor(a / 2);
				...
				for (var a = c = 1, k = [], h = 0; h < e.length; h++) {
					var l = e[h];
					k.push(l[g]);
					1 < l[g].rowSpan && (h += l[g].rowSpan - 1)
				}
		...
		CKEDITOR.plugins.tabletools = {
			...
			init: function(d) {
				...
				var c = d.lang.table,
					...
					g = "td{width} td{height} td{border-color} td{background-color} td{white-space} td{vertical-align} td{text-align} td[colspan] td[rowspan] th".split(" ");
				...
				d.addMenuItems && d.addMenuItems({
					tablecell: {
						...
						getItems: function() {
							...
							d.filter.check(g) && (a.tablecell_properties = 0 < b.length ? CKEDITOR.TRISTATE_OFF : CKEDITOR.TRISTATE_DISABLED);
							return a
						}
					},
	...
	(function() {
		...
		e.prototype = {
			...
			refreshState: function() {
				countRefreshState++;
				//alert('countRefreshState-->'+countRefreshState);
				if(countRefreshState==3){
					this.hasUndo = !!this.getNextImage(!1);
				}else{
	...
	(function() {
		...
		function P(a) {
			...
			b.on("selectionChange", function(c) {
				...
				e ? e === d && e.focusedEditable.equals(c) || (p(a, e, null), d && c && p(a, d, c)) : d && c && p(a, d, c)
			});
		...
		function F(a) {
			...
			return {
				...
				commit: function() {
					...
					for (f && (h = a.focused) && w(a, h); h = d.pop();) b.splice(CKEDITOR.tools.indexOf(b, h), 1), h.isInited() && (l = h.editor.checkDirty(), h.setSelected(!1), !l && h.editor.resetDirty());
		...
		function U(a, b) {
			...
			a.on("key", function(b) {
				...
				if (13 == b) a.edit();
					...
					if (b in L || CKEDITOR.CTRL & b || CKEDITOR.ALT & b) return
				}
				return !1
			}, null, null, 999);
		...
		function ka() {
			...
			function c(a) {
				...
				function c(a) {
					function b(a, c) {
						var d = CKEDITOR.tools.objectKeys(a),
							e = CKEDITOR.tools.objectKeys(c);
		...
		g.prototype = {
			...
			initEditable: function(a, b) {
				...
				}), c.filter && c.data("cke-filter", c.filter.id), c.addClass("cke_widget_editable"), c.removeClass("cke_widget_editable_focused"), b.pathName && c.data("cke-display-name", b.pathName), this.editor.focusManager.add(c), c.on("focus", K, this), CKEDITOR.env.ie && c.on("blur", J, this), c._.initialSetData = !0, c.setData(c.getHtml()), !0) : !1
			},
